        ...
        <div className="flex min-h-screen flex-col items-center justify-center gap-3 bg-slate-950 p-8 text-center text-slate-100">
          ...
          <div className="mt-2 flex gap-2">
            <button
              ...
              className="rounded-xl bg-beat px-4 py-2.5 text-sm font-semibold text-onaccent hover:bg-green-400"
            >
              Reload
            </button>
            <button
              onClick={this.handleHome}
              className="rounded-xl bg-slate-800 px-4 py-2.5 text-sm text-slate-100 hover:bg-slate-700"
            >
              Go home
            </button>
          </div>
