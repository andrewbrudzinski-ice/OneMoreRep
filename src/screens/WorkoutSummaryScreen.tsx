...
export function WorkoutSummaryScreen() {
  ...
  return (
    <div className="mx-auto min-h-screen max-w-2xl px-4 pb-24 pt-8">
      ...
      <div className="mt-4 rounded-2xl border border-slate-800 bg-slate-900/50 p-5 text-center">
      ...
      <div className="mt-6">
        ...
        {summary.newPRs.length === 0 ? (
          <p className="rounded-2xl border border-slate-800 bg-slate-900/50 p-4 text-sm text-slate-400">
          ...
          <ul className="space-y-2">
            {summary.newPRs.map((pr) => (
              <li
                key={pr.id}
                className="flex items-center justify-between rounded-xl border border-beat/30 bg-beat/5 px-4 py-3"
              >
                <div>
